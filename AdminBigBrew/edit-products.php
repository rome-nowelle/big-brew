...
<div class="container">
    ...
    <?php
        if(isset($_GET['CategoryID']))
        {
            ...
            $product = getByID("products", $categoryid);
    ...
    if (!empty($categories)) {
        foreach ($categories as $item) {
            ?>
            <option value="<?= $item['categoryid']; ?>"> <?=$data['CategoryID'] == $item['CategoryID']?> <?= $item['name']; ?></option>
            <?php
        }
    } else {
    ...
    ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary" name="edit_products_btn">Update</button>
                        </div>
                    </div>
                </form>
            </div>
