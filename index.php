...
<body>
  ...
  <section class="about" id="about">
    ...
    <div class="about-text">
      ...
      <p>We currently have 100+ branches in Central Luzon and Metro Manila. we have made incredible strides in
        delivering high-quality and innovative milk tea products. Our commitment to using only the finest ingredients
        and environmentally friendly practices has enabled us to build a loyal customer base and attract investors who
        share our vision for success. </p>
      <p>With each passing year, we have continued to push the boundaries of what is possible in the milk tea industry,
        and we are excited to see what the future holds. Join us on this journey as we strive to make our mark in
        history and change the game for milk tea lovers worldwide.</p>
