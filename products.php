  ...
  <section class="products1" id="products">
    ...
    <div class="product-container1">
      <div class="box">
        ...
        <div class="contenta">
          <a href="registration.php"><i class='bx bxs-cart-add'></i></a>
          <a href="registration.php"><i class='bx bxs-cart-add'></i></a>
        </div>
      </div>
      <div class="box">
  ...
  <section class="products3" id="products">
    ...
    <div class="product-container3">
      <div class="box">
        ...
        <div class="content">
          <span>₱ 29</span>
          <a href="registration.php">Add to cart</a>
        </div>
        <div class="contentd">
          <p>Grande</p>
        </div>
  ...
  <section class="addons" id="products">
    ...
    <div class="product-container6">
      <div class="box">
        ...
        <h3>PEARL</h3>
        <div class="content">
          <a href="registration.php"><i class='bx bx-plus-circle'></i></a>
        </div>
      </div>
      <div class="box">
        <img src="img/NO PICTURE YET.png" alt="">
